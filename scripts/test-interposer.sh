...
[ "$adopt_count" -ge 3 ] || { echo "expected fork, clone, and vfork ADOPT, got $adopt_count" >&2; exit 1; }
...
echo "native interposer TCP/UDP, raw syscall, clone, clone3, vfork, and pthread lifecycle passed"
